...
![Left to right: no denoising, denoise with 32x32 filter, denoise with 64x64 filter](img/denoiser_various_filters.png)
...
![Left to right: high normal weight and low color weight, low normal weight and high color weight](img/denoiser_70x70_various_weights.png)
